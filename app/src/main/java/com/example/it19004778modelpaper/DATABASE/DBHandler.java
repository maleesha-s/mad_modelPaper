...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "dbusser.db";
    ...
    public long AddInfor(String username, String dob, String password, String gender){
    ...
    public List readAllInfo() {
        ...
        String sortOrder =
                UserProfile.Users.COLUMN_1 + " DESC"; //ASC
